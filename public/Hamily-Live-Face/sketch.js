...
class Robot {
    ...
    draw(canvas, glassesCanvas) {
        canvas.push();
        canvas.noStroke();
        canvas.translate(WIDTH/2, this.p.y);
        canvas.rotate(-this.robotRotation);
        /*if(HEIGHT < 600){
            scale(0.5)
        }*/

        // rotate(this.ang + sin(mouseX / 200 + frameCount / 50 + this.p.x + this.p.y) / 4);
        // canvas.scale(this.SizeMultiply)
        canvas.rectMode(CENTER);
        canvas.ellipseMode(CENTER);
        canvas.fill(this.colors[0]);
        ...
        canvas.fill(this.colors[5]);
        //circle(-this.size.x / 2 - 5 * 4.5, 0, this.earSize.x * 3, this.eyeSizes.y * 3);
        canvas.circle(-this.size.x / 2 - this.p.x / 15, 0, this.earSize.x * 3, this.eyeSizes.y * 3);

        canvas.fill(this.colors[5]);
        //circle(this.size.x / 2 + 5 * 4.5, 0, this.earSize.x * 3, this.eyeSizes.x * 3);
        canvas.circle(this.size.x / 2 + this.p.x / 15, 0, this.earSize.x * 3, this.eyeSizes.x * 3);
        canvas.pop();
        ...
        if(int(this.mouth) == 0){
            if(this.mouthVector ==1 || this.mouthVector ==2){
                canvas.rect(-this.size.x / 2, -this.size.y / 2, this.size.x, this.size.y + this.addPos * 2, this.corner);
            }else 
            canvas.rect(-this.size.x / 2, -this.size.y / 2, this.size.x, this.size.y, this.corner);
        }else{
            canvas.rect(-this.size.x / 2, -this.size.y / 2, this.size.x, this.size.y, this.corner);  
        }
        // rect(-this.size.x / 2, -this.size.y / 2, this.size.x, this.size.y + this.addPos * 2, this.corner);
        canvas.pop();
        canvas.noStroke();

        //--------------Left Eye--------------//
        // let slX = (this.leftEyeMultiply > 0.8) ? this.leftEyeMultiply : 1; 
        canvas.push()
        canvas.translate(-WIDTH/10.9, 0)
        canvas.scale(1, this.leftEyeMultiply)
        canvas.stroke(this.colors[1]);
        canvas.strokeWeight(this.strokeWeight);
        canvas.fill(0);
        // circle(-18 * 4.5, 0, this.eyeSizes.x - sin(frameCount / 50 + mouseY / 20) * 2 * 4.5);
        canvas.circle(0, 0, this.eyeSizes.x - sin(frameCount / 50 + mouseY / 20) * this.p.x / 50);
        canvas.pop()

        //--------------Right Eye--------------//
        // let srX = (this.leftEyeMultiply > 0.8) ? this.leftEyeMultiply : 1; 
        canvas.push()
        canvas.translate(WIDTH/10.9, 0)
        canvas.scale(1, this.rightEyeMultiply)
        canvas.stroke(this.colors[2]);
        canvas.strokeWeight(this.strokeWeight / 2);
        canvas.fill(0);
        // circle(18 * 4.5, 0, this.eyeSizes.x + sin(frameCount / 50 + mouseY / 20) * 2 * 4.5);
        canvas.circle(0, 0, this.eyeSizes.x + sin(frameCount / 50 + mouseY / 20) * this.p.x / 50);
        ...
        //--------------Right Eyebrows--------------//
        canvas.noStroke();
        canvas.fill(this.colors[3]);
       
        canvas.push();
        canvas.fill(this.colors[4]);
        canvas.translate(0, -this.rightEyeBrowPos * this.p.y / 15);
        canvas.rotate(sin(frameCount / 30) / 6);
        ...
        canvas.rect(WIDTH/10.9, -WIDTH/10.9 + sin(frameCount / 50) * 5, this.eyeSizes.x * 1.3, this.p.x/15);

        canvas.pop();

        //--------------Left Eyebrows--------------//
        canvas.push();
        canvas.fill(this.colors[6]);
        canvas.translate(0, -this.leftEyeBrowPos * this.p.y / 15);
        canvas.rotate(sin(frameCount / 20 + 1) / 5);
        ...
        canvas.rect(-WIDTH/10.9, -WIDTH/10.9 + sin(frameCount / 20) * 5, this.eyeSizes.x, this.p.x/15);

        canvas.pop();

        //--------------Forehead Rect--------------//
        canvas.fill(this.colors[3]);
        canvas.rect(0, -this.size.y / 2 + sin(frameCount / 20 + 0.5) * 5, this.antennaSize.x, this.antennaSize.y);

        //--------------Nose--------------//
        canvas.fill(this.colors[5]);

        //circle(0, this.size.y / 10 + sin(frameCount / 20) * 5, 20, 20);
        canvas.circle(0, this.size.y / 10 + sin(frameCount / 20) * 5, WIDTH/45, WIDTH/45);
        ...
        switch (int(this.mouth)) {
            case 0:
                switch (this.mouthVector) {
                    case 0:
                        canvas.rotate(sin(frameCount / 10 + mouseX / 50 + mouseY / 50) / 5);
                        canvas.fill(this.colors[6]);
                        //rect(0, this.size.y / 3, this.size.x / 2, 5 * 4.5, 30);
                        canvas.push();
                        canvas.translate(0, this.size.y / 3 + this.addPos / 5);
                        canvas.rotate(this.mouthVerMultiply / 4 * sin(frameCount / 10));
                        canvas.rect(0, 0, this.size.x / 2 + this.mouthWide, this.p.x/15 + this.mouthThickness / 5, this.p.x/15 + this.mouthThickness / 5);
                        canvas.pop();
                        break;
                    case 1:
                        canvas.rotate(sin(frameCount / 10 + mouseX / 50 + mouseY / 50) / 5);
                        canvas.noStroke();
                        canvas.fill(this.colors[7]);
                        //arc(0, this.size.y / 4, 160, 120, 0, PI, CHORD);
                        canvas.arc(0, this.size.y / 4 + this.addPos /2, WIDTH/5.5 + this.mouthWide, this.p.x/4 + this.mouthThickness, 0, PI, CHORD);
                        break;
                    case 2:
                        canvas.noStroke();
                        canvas.fill(this.colors[8]);
                        // arc(0, this.size.y / 3, 120 - sin(frameCount / 50) * 30, 80, 0, TWO_PI, CHORD);
                        canvas.arc(0, this.size.y / 3 + this.addPos, this.p.x/4 - sin(frameCount / 50) * this.p.x/15 + this.mouthWide, WIDTH/11 + this.mouthThickness, 0, TWO_PI, CHORD);
                        // //test dot
                        // fill(255,0,0)
                        // circle(0, this.size.y / 3+this.addPos,10)
                        // fill(0,255,0)
                        // circle(this.p.x/4 - sin(frameCount / 50) * this.p.x/15- sin(frameCount / 50) * this.p.x/15, WIDTH/11, 10)
                        break;
                    case 3:
                        canvas.push();
                        canvas.stroke(this.colors[2]);
                        canvas.strokeWeight(this.strokeWeight / 2 + this.mouthThickness / 10);
                        canvas.noFill();
                        // arc(0, this.size.y / 2.5, 120, 70 - sin(frameCount / 50) * 10, PI, TWO_PI);
                        canvas.arc(0, this.size.y / 2.5 + this.addPos / 100, this.p.x/4 + this.mouthWide, WIDTH/11.5 - sin(frameCount / 50) * this.p.x/45 + this.mouthThickness, PI, TWO_PI);
            ...
            case 1:
                ...
                canvas.noFill();      
                // arc(0, this.size.y / 4, 120 - sin(frameCount / 50) * 30, 80, 0, PI, TWO_PI);
                canvas.arc(0, this.size.y / 4 + this.addPos / 40, this.p.x/4 - sin(frameCount / 50) * this.p.x/15 + this.mouthWide, WIDTH/11 + this.mouthThickness, 0, PI, TWO_PI);
                canvas.pop();
                break;
            case 2:
                canvas.rotate(sin(frameCount / 10 + mouseX / 50 + mouseY / 50) / 5);
                ...
                canvas.push();
                canvas.translate(0, this.size.y / 3 + this.addPos / 5);
                canvas.rotate(this.mouthVerMultiply / 2 * sin(frameCount / 10));
                // rect(0, this.size.y / 3, this.size.x / 4, 5 * 4.5, 30);
                canvas.rect(0, 0, this.size.x / 4 + this.mouthWide, this.p.x / 15 + this.mouthThickness / 5, this.p.x/15 + this.mouthThickness / 5);
                canvas.pop();
                break;
            case 3:
                canvas.image(this.botLips , -WIDTH/12 - this.mouthWide / 2, WIDTH/10.2, WIDTH/6 + this.mouthWide, WIDTH/16.5 + this.mouthThickness / 5);
                // imageMode(CORNERS)
                // image(this.botLips , -WIDTH/12, WIDTH/10.2, -WIDTH/12 + WIDTH/6 +this.p.x / 5*this.mouthRightMultiply , WIDTH/10.2 + WIDTH/16.5 + this.mouthThickness);
                // pop()
                break;
        }
        canvas.pop();
        ...
        //--------------Glasses--------------//    
        glassesCanvas.push();
        glassesCanvas.translate(WIDTH/2, this.p.y);
        glassesCanvas.rotate(-this.robotRotation);
        glassesCanvas.rectMode(CENTER);
        glassesCanvas.noStroke();
        switch (int(this.glassType)) {
            case 0:
                switch (this.glassVector) {
                    case 0:
                        glassesCanvas.rotate(-sin(frameCount / 10 + mouseX / 50 + mouseY / 50) / 10);
                        glassesCanvas.stroke(this.colors[9]);
                        glassesCanvas.strokeWeight(this.glassStrokeWeight);
                        glassesCanvas.fill(123, 44, 191, 100);
                        //rect(-81, 0, this.glassSize.x, this.glassSize.y, this.corner);
                        glassesCanvas.rect(-WIDTH/10.9, 0, this.glassSize.x, this.glassSize.y, this.corner);
                        glassesCanvas.rect(WIDTH/10.9, 0, this.glassSize.x, this.glassSize.y, this.corner);
                        glassesCanvas.fill(this.colors[9]);
                        glassesCanvas.noStroke();
                        //rect(0, 0, 60, 15, this.corner);
                        glassesCanvas.rect(0, 0, this.p.x/7.5, this.p.x/30, this.corner);
                        break;
                    case 1:
                        glassesCanvas.rotate(-sin(frameCount / 10 + mouseX / 50 + mouseY / 50) / 10);
                        glassesCanvas.stroke(this.colors[9]);
                        glassesCanvas.fill(123, 44, 191, 100);
                        //circle(-81, 0, 100);
                        glassesCanvas.circle(-WIDTH/10.9, 0, WIDTH/9);
                        //circle(81, 0, 100);
                        glassesCanvas.circle(WIDTH/10.9, 0, WIDTH/9);
                        glassesCanvas.fill(this.colors[9]);
                        glassesCanvas.noStroke();
            ...
            case 2:
                ...
                glassesCanvas.rect(-WIDTH/10.9, 0, this.glassSizeCrazy.x, this.glassSizeCrazy.y, this.corner);
                //rect(81, 0, this.glassSizeCrazy.x, this.glassSizeCrazy.y, this.corner);
                glassesCanvas.rect(WIDTH/10.9, 0, this.glassSizeCrazy.x, this.glassSizeCrazy.y, this.corner);
                glassesCanvas.fill(this.colors[9]);
                glassesCanvas.noStroke();
            ...
            case 3:
                glassesCanvas.rotate(-sin(frameCount / 10 + mouseX / 50 + mouseY / 50) / 10);
                if(this.glassSVG === 17) {
                    glassesCanvas.image(this.botGlasses, -WIDTH/6, -WIDTH/24, WIDTH/3, WIDTH/8);
                } else {
                    glassesCanvas.image(this.botGlasses, -WIDTH/6, -WIDTH/24, WIDTH/3, WIDTH/10);
                }
                break;
            default:
                break;
    ...
    update(pos, features) {
        ...
        this.SizeMultiply = features.robotSizeMultiply;
        this.p.x = pos.x;
        this.p.y = pos.y - this.size.y * map(features.robotSizeMultiply, 0.5, 1.8, 0.1, 0.28);
        this.leftEyeBrowPos = features.leftEyebrowPos;
        this.rightEyeBrowPos = features.rightEyebrowPos;
        this.leftEyeMultiply = features.leftEyeMultiply;
        this.rightEyeMultiply = features.rightEyeMultiply;
        this.robotRotation = features.robotRotation;
        this.mouthVerMultiply = features.mouthVerMulitply;
        this.mouthHorMultiply = features.mouthHorMulitply;
        this.mouthRightMultiply = features.mouthRightMultiply;
        this.mouthLeftMultiply = features.mouthLeftMultiply;
        this.addPos = (this.mouthVerMultiply > 0) ? this.mouthVerMultiply *50 : 0;
        this.mouthThickness = this.p.x / 5 * this.mouthVerMultiply;
        this.mouthWide = this.p.x / 5 * this.mouthHorMultiply;
        //-----press 'g' to switch face style-----//
        if(switchRobot){
            Rseed = new Random(seed);
            selectedPlanet = Rseed.random_int(0, 5);
            pitircik = Rseed.random_choice(availableNoiseLevels);
            this.mouth = Rseed.random_int(0, 3)
            this.mouthVector = Rseed.random_int(0, 3)
            this.mouthSvg = Rseed.random_int(0, 9)
            this.glassType = Rseed.random_int(0, 3)
            this.glassSVG = Rseed.random_int(0, 17)
            this.glassVector = Rseed.random_int(0, 1)

            this.botGlasses = loadImage("data:image/svg+xml;base64," + btoa(combinedGlasses[this.glassSVG]))
            this.botLips = loadImage("data:image/svg+xml;base64," + btoa(allLips[this.mouthSvg]))
            ...
            this.randomId = Rseed.random_int(0, 500)
            this.glassSize = createVector(Rseed.random_between(WIDTH/10, WIDTH/9), Rseed.random_between(WIDTH/11, WIDTH/10)),
            this.glassSizeCrazy = createVector(Rseed.random_between(WIDTH/9, WIDTH/8), Rseed.random_between(WIDTH/6, WIDTH/5)),
            this.size = createVector(Rseed.random_between(WIDTH/3, WIDTH/2), Rseed.random_between(WIDTH/3, WIDTH/2)),
            this.antennaSize = createVector(Rseed.random_between(WIDTH/30, WIDTH/(7.5)), Rseed.random_between(WIDTH/30, WIDTH/5)),
            this.earSize = createVector(Rseed.random_between(WIDTH/90, WIDTH/30), Rseed.random_between(WIDTH/45, WIDTH/25)),
            this.colors =  [
                Rseed.random_choice(colors),
                Rseed.random_choice(colors1),
                Rseed.random_choice(colors2),
            ...
            this.eyeSizes = createVector(
            Rseed.random_between(WIDTH/15, WIDTH/7.5),
            Rseed.random_between(WIDTH/15, WIDTH/7.5)),
            this.ang = Rseed.random_between(-0.1, 0.1),
            this.corner = Rseed.random_choice([0, 0, WIDTH/180, WIDTH/45, WIDTH/18]),
            this.strokeWeight = Rseed.random_between(WIDTH/45, WIDTH/22.5),
            this.glassStrokeWeight = Rseed.random_between(WIDTH/45, WIDTH/30),
...
class FacialFeatures {
  constructor(args) {
    this.leftEyebrowPos = args.leftEyebrowPos;
    this.robotSizeMultiply = args.robotSizeMultiply;
    this.rightEyebrowPos = args.rightEyebrowPos;
    this.robotRotation = args.robotRotation;
    this.leftEyeMultiply = args.leftEyeMultiply;
    this.rightEyeMultiply = args.rightEyeMultiply;
    this.mouthVerMulitply = args.mouthVerMulitply;
    this.mouthHorMulitply = args.mouthHorMulitply;
    this.mouthLeftMultiply = args.mouthLeftMultiply;
    this.mouthRightMultiply = args.mouthRightMultiply;
...
let switchRobotBtn, showCaptureBtn, showHintBtn, waveModeBtn, liveModeBtn, alphaModeBtn, pauseBtn;
let hashInput;
let hashBtn;
...
let sRobotPosX_NORMALIZE = 0;
let sRobotPosY_NORMALIZE = 0;
let mouthTop;
let mouthBottom;
let mouthLeft;
let mouthRight;
...
let boxWidth = WIDTH;
let faceSize = WIDTH;
let leftEyebrowTemp = 0;
let rightEyebrowTemp = 0;
let mouthVerTemp = 0;
let mouthHorTemp = 0;
let mouthLeftTemp = 0;
let mouthRightTemp = 0;
let leftEyeTemp = 0;
let rightEyeTemp = 0;
let eyesGap = 0;
let robotRotationY = 0;
let robotRotationYTemp = 0;
let facialFeatures = new FacialFeatures({
    leftEyebrowPos: 0,
    rightEyebrowPos: 0, 
    robotSizeMultiply: 1,
    robotRotation: 0,
...
function setup() {
    ...
    smoothedRobotPos = createVector(WIDTH/2, HEIGHT/2);
    addRobot(robotPos);

    sunColor = color(Rseed.random_choice(colorYellow));
    mountainColor = color(Rseed.random_choice(colorBlue));
    bgColor = color(0);
    bgNightColor = color(0);
    bgDayColor = sunColor;
    bgDayColor.setAlpha(1);
    c1 = color(29, 90, 231);
    ...
    LiveBtn = createDiv("Live");
    AlphaBtn = createDiv("Alpha");
    btnText = [ShowCloseBtn, RandomBtn, SeaBtn, LiveBtn, AlphaBtn]
    mobileTextSpace = [0.045,0.235,0.455,0.615,0.765]
    pcTextSpace = [0.025,0.13,0.257,0.345,0.43]
...
function drawBox(detections){
    for(let i = 0; i < detections.length; i++){
        ...
        if(showCapture){
            ...
            stroke(0, 255, 0);
            strokeWeight(2);
            rect(-WIDTH+x, y, boxWidth, boxHeight);        
            pop();
        }
...
function drawLandmarks(detections){
    ...
    for(let i = 0; i < detections.length; i++){
        mouthTop = detections[i].parts.mouth[3];  //20
        mouthBottom = detections[i].parts.mouth[9];  //20
        mouthLeft = detections[i].parts.mouth[0];  //20
        mouthRight = detections[i].parts.mouth[6];  //20
        nose = detections[i].parts.nose[3];  //9
        leftEye = detections[i].parts.leftEye[2];  //6
        leftEyeBottom = detections[i].parts.leftEye[4];  //6
        // leftEyeR = detections[i].parts.leftEye[3];  //6
        rightEye = detections[i].parts.rightEye[2];  //6
        rightEyeBottom = detections[i].parts.rightEye[4];  //6
        // rightEyeL = detections[i].parts.rightEye[0];  //6
        rightEyeBrow = detections[i].parts.rightEyeBrow[2];  //5
        leftEyeBrow = detections[i].parts.leftEyeBrow[2];  //5

        if(showCapture){
            drawPart(mouthTop);
            drawPart(mouthBottom);
            drawPart(mouthLeft);
            drawPart(mouthRight);
            drawPart(nose);
            drawPart(leftEye);
            drawPart(leftEyeBottom);
            // drawPart(leftEyeR);
            drawPart(leftEyeBrow);
            drawPart(rightEye);
            drawPart(rightEyeBottom);
            // drawPart(rightEyeL);
            drawPart(rightEyeBrow);
        }
    }

}

function drawPart(feature){
        const x = feature._x
        const y = feature._y
        point(-WIDTH+x, y);   
}
...
function setSwitchRobot(){
    seed = random(10000000+frameCount);  //temporary
    switchRobot = true;
}
...
function hashRobotGenerate(){
    // if(hashInput.value()!=''){
    //     seed = hashInput.value() ////67955386739831850
    //     switchRobot = true;
    // }

    if(hashInput.value()!=''){
        if(tokenList[parseInt(hashInput.value())]){
            let tokenhash = tokenList[parseInt(hashInput.value())]
            seed = parseInt(tokenhash.hash.slice(0, 16), 16)
        }else{
            seed = int(Rseed.random_between(0, 10000)); // input error set random
        }
        // seed = hashInput.value() ////67955386739831850
        console.log(seed)
        switchRobot = true;
...
function draw() {
    ...
    //         //------draw nose position-----//
    //         smoothedRobotPos = smoothValue(pose.keypoints[0].position, smoothedRobotPos, smoothedPosValue)
    //         fill(0,255,0)
    //         ellipse(-WIDTH+pose.keypoints[0].position.x, pose.keypoints[0].position.y, d*0.3)  //Nose Position
    //         fill(255,0,0)
    ...
    if(bgMode == 1){
        ...
        background(bgColor);
        bgTargetColor = (sRobotPosY_NORMALIZE<0.5)? bgDayColor : bgNightColor;
        bgColor = lerpColor(bgColor,bgTargetColor, 0.1);
    
        // background(bgDaylight);
        sol(sunColor);
        push();
        fill(BGCOL);
        ...
        push()
            if (detections) {
                if (detections.length > 0) {
                    ...
                    smoothedRobotPos = smoothValue(smoothedRobotPos, nose, 0.2);
                    faceSize = lerp(faceSize, boxWidth, smoothedPosValue);
                    facialFeatures.robotSizeMultiply = (faceSize / WIDTH) * 4.5;
                    // facialFeatures.robotSizeMultiply = 0.5 + (faceSize / WIDTH) * 1.5;
                    leftEyebrowTemp = map((leftEye.y - leftEyeBrow.y) / boxWidth, 0.1, 0.25, -0.5, 1.5);
                    facialFeatures.leftEyebrowPos = lerp(facialFeatures.leftEyebrowPos, leftEyebrowTemp, 0.3);
                    rightEyebrowTemp = map((rightEye.y - rightEyeBrow.y) / boxWidth, 0.1, 0.25, -0.5, 1.5);
                    facialFeatures.rightEyebrowPos = lerp(facialFeatures.rightEyebrowPos, rightEyebrowTemp, 0.3);
                    facialFeatures.robotRotation = lerp(facialFeatures.robotRotation, atan2(rightEye.y - leftEye.y, rightEye.x - leftEye.x), smoothedPosValue);
                    mouthVerTemp = map((mouthBottom.y - mouthTop.y) / boxWidth, 0.05, 0.5, -0.5, 1.5);
                    facialFeatures.mouthVerMulitply = lerp(facialFeatures.mouthVerMulitply, mouthVerTemp, smoothedPosValue);
                    mouthHorTemp = map((mouthRight.x - mouthLeft.x) / boxWidth, 0.2, 0.45, -0.5, 1.5);
                    facialFeatures.mouthHorMulitply = lerp(facialFeatures.mouthHorMulitply, mouthHorTemp, smoothedPosValue);
                    facialFeatures.centerX = lerp(facialFeatures.centerX, (leftEye.x + rightEye.x) / 2, smoothedPosValue);
                    mouthLeftTemp = map((mouthRight.x - facialFeatures.centerX) / boxWidth, 0.1, 0.25, -0.5, 1.5);           //left right switch
                    facialFeatures.mouthLeftMultiply = lerp(facialFeatures.mouthLeftMultiply, mouthLeftTemp, smoothedPosValue);
                    mouthRightTemp = map((facialFeatures.centerX - mouthLeft.x) / boxWidth, 0.1, 0.25, -0.5, 1.5);
                    facialFeatures.mouthRightMultiply = lerp(facialFeatures.mouthRightMultiply, mouthRightTemp, smoothedPosValue);
                    
                    // leftEyeTemp = map((leftEyeBottom.y - leftEye.y) / boxWidth, 0.04, 0.065, 0.1, 1, true);     //left right switch
                    // leftEyeTemp = (nose.y - leftEye.y)/(nose.y - leftEyeBottom.y);     //left right switch
                    // leftEyeTemp = (leftEyeBottom.y - leftEye.y)/(boxWidth*cos(facialFeatures.robotRotation));     //left right switch
                    // leftEyeTemp = (leftEyeBottom.y - leftEye.y)/(rightEyeL.x-leftEyeR.x)
                    // leftEyeTemp = (leftEyeTemp<0.235)? 0.1 : 1; 
                    eyesGap = (rightEyeBottom.x-leftEyeBottom.x)
                    ...
                    // rightEyeTemp = (rightEyeBottom.y - rightEye.y)/(boxWidth*cos(facialFeatures.robotRotation));     
                    // rightEyeTemp = (rightEyeTemp<0.055)? 0.1 : 1; 
                    // rightEyeTemp = (rightEyeBottom.y - rightEye.y)/(rightEyeL.x-leftEyeR.x)
                    // rightEyeTemp = (rightEyeTemp<0.235)? 0.1 : 1;
                    ...
                    let eyesRatio = abs(rightEye.x - nose.x) / abs(nose.x - leftEye.x)
                    if(eyesRatio < 1 ){
                        robotRotationYTemp =  map(eyesRatio, 0.1, 1, -1, 0, true);
                    }else{
                        robotRotationYTemp =  map(eyesRatio, 1, 10, 0, 1, true);
                    }                    
                    robotRotationY = lerp(robotRotationY, robotRotationYTemp, smoothedPosValue);
                }
            }
        pop()     
    pop()

    sRobotPosX_NORMALIZE = map(smoothedRobotPos.x, 0, WIDTH, 0, 1);
    sRobotPosY_NORMALIZE = map(smoothedRobotPos.y, 0, HEIGHT, 0, 1);
    robot.update(smoothedRobotPos, facialFeatures);
    robot.draw(faceCanvas, glassesCanvas);
    ...
    image(webGlGraphics2,smoothedRobotPos.x, height/2);
    pop()
    faceCanvas.clear();
    glassesCanvas.clear();
    ...
    text("Face", 10, HEIGHT * 0.03);
    text("posX: "+floor(smoothedRobotPos.x), 10, HEIGHT * 0.07);
    text("posY: "+floor(smoothedRobotPos.y), 10, HEIGHT * 0.11);
    // push()
    // textSize(15);
    // textAlign(RIGHT);
    // text("Generate a new robot: Press 'G'", width-30, 30);
    // text("Show or close the captured window: Press 'C'", width-30, 55);
    // text("Switch background mode: Press '1/2/3'", width-30, 80);
    // text("Pause or continue: Press Space", width-30, 105);
    // text("Show or close the hint: Press 'H'", width-30, 130);
    // pop()
    ...
    if(document.documentElement.clientWidth<450){
        btnSize = WIDTH/8
        inputSize1 = WIDTH*0.65
        inputSize2 = WIDTH*0.2
        inputHeight = WIDTH*0.1
        inputTextSize = HEIGHT*0.03
        saveBtnSize = WIDTH/9
    }else{
        btnSize = WIDTH/20
        inputSize1 = WIDTH/3.5
        inputSize2 = WIDTH/8
        ...
        if(WH/WIDTH > 2){
            ...
            document.getElementById('download_mp4_hint').textContent = "takes 1 min";
        }else{
            document.getElementById('download_webm_hint').textContent = "done immediaely";
            document.getElementById('download_mp4_hint').textContent = "render takes 1 min";
        }
    }
    
    showCaptureBtn.size(btnSize, btnSize)
    switchRobotBtn.size(btnSize, btnSize)
    waveModeBtn.size(btnSize, btnSize)
    liveModeBtn.size(btnSize, btnSize)
    alphaModeBtn.size(btnSize,btnSize)
    hashInput.size(inputSize1, inputHeight)
    ...
    if(!isModelLoaded){
        ...
        fill(37,37,37)
        rectMode(CENTER)
        rect(0,0,WIDTH*0.9,WIDTH/10)
        fill(255)
        textFont('Roboto');
        textStyle(BOLD);
        textSize(HEIGHT/35);
        textAlign(CENTER, CENTER);
        text("Loading Face Tracking Model ...",0,0)
        pop()
    }
    if(isModelLoaded && loadedCount<20){
        push()
        translate(WIDTH/2,HEIGHT/2)
        fill(142, 240, 101)
        rectMode(CENTER)
        rect(0,0,WIDTH/3,WIDTH/10)
        fill(255)
        textFont('Roboto');
        textStyle(BOLD);
        textSize(HEIGHT/30);
    ...
    if(document.documentElement.clientWidth<450){
        ...
        bgRect.style('background', 'rgba(37,37,37,0.8)')
        bgRect.position(document.body.clientWidth/2 - WIDTH/2, document.body.clientHeight/2 + HEIGHT/2 - HEIGHT*0.1)
        bgRect.style('width', WIDTH*0.52+"px")
        bgRect.style('height', HEIGHT*0.1 +"px")
    }
    ...
    window.showFps && stats?.end?.()
}

function sol(gunesColor) {
    gunesColor.setAlpha(255);
    let facePos = 1-sRobotPosY_NORMALIZE; //upper higher
    let lightScale = 1+facePos;
    let lightAmount = ceil(map(facePos, 0, 1, 1, 4));
    let bg = color(0);
    push();
    fill(gunesColor);
    ...
    bg.setAlpha(70);
    fill((gunesColor));
    for(let i = 1; i<= lightAmount; i++){
        let r = map(i, 1, lightAmount, ellipse1$, ellipse2$);
...
function smoothValue(smoothedData, data, smoothedValue){
    let dx = map(data._x, 0, WIDTH, WIDTH, 0);
    let dy = data._y;
    //poseNet
    // let dx = map(data.x, 0, WIDTH, WIDTH, 0);
    // let dy = data.y;
    let smoothedx = smoothedData.x;
    let smoothedy = smoothedData.y;
    smoothedx = lerp(smoothedx, dx, smoothedValue);
    smoothedy = lerp(smoothedy, dy, smoothedValue);

    if(smoothedx < 0){
        smoothedx = 0;
    }else if(smoothedx > WIDTH){
        smoothedx = WIDTH;
    }
    if(smoothedy < 0){
        smoothedy = 0;
    }else if(smoothedy>HEIGHT){
        smoothedy = HEIGHT;
    }
    let sdata = createVector(smoothedx, smoothedy)
    return sdata;
}

function playSound(f, amp){
    osc.freq(f)
	env.setRange(amp, 0)	
	env.play(); 
}
...
function windowResized() {
    ...
    availableNoiseLevels = [WIDTH / 25, WIDTH / 9, WIDTH / 5]
    DIM = Math.min(WIDTH, HEIGHT);
    boxWidth = WIDTH;
    faceSize = WIDTH;
    M = DIM / DEFAULT_SIZE;
    ellipse1$ = HEIGHT / 5 + HEIGHT / 30
